function binFix(param1){

    // this.bftoBin = function(inputHex){
    // 	/* 
    ...
    // this.bfconvert = function(binArray, outType = 'num'){
    // 	/*
    ...
    // 		    switch(tempArray.join('')){                                         //conversion table
    ...
    // this.bfToDec = function(){
    // 	return self.bfconvert(outputOfbinFix, 'num');
    // }


    function bftoBin(inputHex){
	/* 
	 * Input Hex Number as String or Number and
	 * Return Binary Number as Array
	 * Also accepts other bases than Hexadecimal when passed as Number
    ...
    function bfconvert(binArray, outType = 'num'){
	/*
	 * binConvert converts a binary Array to either a number or a string
	 * The string can be hexadecimal or decimal.
	 * Decimal-string and number might become inaccurate.
    ...
    var self = this;
    var outputofbinFix = null;

    self.outputOfbinFix = bftoBin(param1);

    return self.outputofbinFix;
 ...
 * flip
 * set, reset
 * Es müssen immer zwei gleich lange Arrays verglichen werden
 * sonst wird das kürzere intern mit Nullen aufgefüllt.
 */
